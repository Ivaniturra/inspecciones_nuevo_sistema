...
class Inspecciones extends BaseController
{
    ...
    public function store()
    {
        ...
        // Preparar datos con nomenclatura correcta
        $data = [
            ...
            'inspecciones_comuna' => $this->request->getPost('comuna'),
        ...
        // Crear inspección con comentario automático
    ...
    /**
     * Mostrar detalles de una inspección
     */
