...
<div class="auth-wrap">
  ...
  <section class="auth-hero">
    ...
    <div class="inner">
      <div> 
        <!-- Logo pequeño con valores por defecto seguros -->
        <img src="<?= base_url((env('app.ubicacion_logo_pagina') ?? 'assets/img/') . (env('app.imagen_nomb_logo2') ?? 'login-hero.jpg')) ?>" 
             style="height:48px" class="mb-3" alt="Logo" onerror="this.style.display='none'"> 
        
        <!-- CORREGIDO: Solo mostrar el título, sin base_url() -->
        ...
        <!-- Imagen ilustrativa con fallback -->
        <img class="hero-img" 
             src="<?= base_url((env('app.ubicacion_logo_pagina') ?? 'assets/img/') . (env('app.imagen_nomb_logo') ?? 'logo.jpg')) ?>"
             alt="Ilustración de acceso" 
             onerror="this.src='data:image/svg+xml;base64,'">
      </div>
    </div>
  </section>
        ...
        <form action="<?= base_url('login') ?>" method="post" novalidate autocomplete="on">
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="form-check">
              ...
              <label class="form-check-label" for="remember">ss</label>
            </div>
